...
def repair_pkg():
    ...
    commands = {
        ...
        "snap": [
            (
                ["sudo", "snap", "refresh"],
                "Обновление установленных Snap пакетов...",
            ),
            (
        ...
        "pacman": [
            ...
            (
                ["sudo", "paccache", "-r"],
                "Очистка неиспользуемых версий пакетов...",
            ),
        ],
        "apk": [
            (
        ...
        if manager in commands:
            ...
            for command, message in commands[manager]:
                try:
                    ...
                    # Запуск команды для проверки целостности системы
                    run_command(command)
                    ...
                    # Завершаем выполнение, если произошла ошибка
                    return
